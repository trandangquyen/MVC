            ...
            <div class="top-bar"> <a href="admin/news/add" class="button">Thêm mới</a>
                <h1>Quản trị tin tức</h1>
                <div class="breadcrumbs"><a href="#">Homepage</a> / <a href="#">Tin tức</a></div>
            </div>
            <br />
            ...
            <form method="POST">
                <div class="cont-products">
                    ...
                    <table class="listing" cellpadding="0" cellspacing="0">
                        <tr>
                            <th class="first" width="177">Danh sách tin tức</th> 
                            <th>Xóa</th>
                            <th>Sửa</th>
                    ...
                    foreach ($listnews as $news) { 
                        echo '<tr>
                            <td class="first style3">'.$news['title'].'</td>
                            <td><a href="admin/news/delete/'.$news['id'].'"><img src="public/admin/img/hr.gif" width="16" height="16" alt="Delete" /></a></td>
                            <td><a href="admin/news/edit/'.$news['id'].'"><img src="public/admin/img/edit-icon.gif" width="16" height="16" alt="Edit" /></a></td>
                            <td class="last"><input type="checkbox" name="delete[]" value="'.$news['id'].'"</td>
                        </tr>';
                    }
                    ?>
