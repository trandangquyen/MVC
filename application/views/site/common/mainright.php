  ...
  <div id="main_right">
    ...
    <div class="boder_menu">
      <ul>
        ...
        <li><img src="public/themes/images/li.png" alt="" class="icon_list"><a href="#">Rò rỉ thông tin iphone8  ...</a></li>
        <li><img src="public/themes/images/li.png" alt="" class="icon_list"><a href="#">Đánh giá chi tiết iphone8 ...</a></li>
        <li><img src="public/themes/images/li.png" alt="" class="icon_list"><a href="#">Samsung S8 và S8+   ...</a></li>
        <li><img src="public/themes/images/li.png" alt="" class="icon_list"><a href="#">Với iPhone 8, Apple tự xé ...</a></li>   
      </ul>
    </div><!-- end boder_menu -->
