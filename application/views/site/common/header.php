        ...
        <div id="wrapper">
            ...
            <div class="header container">
				<div id="Icon_search">
                    ...
                    <div id="cart" style="cursor:pointer;" onclick="window.location='cart'">
                        <span class="icon_cart"><img src="public/images/icon_cart.png" alt="cart"></span>
                        <span id="count_shopping_cart_store"><?=count($this->session->userdata('cart')) ?></span> sản phẩm 
                        <a href="cart" id="img-cart" rel="nofollow" style="<?=count($this->session->userdata('cart'))>0 ? '' : 'display: none'?>"><img src="public/images/btn_giohang.png" alt="thanh toán"></a>
                    </div>
                </div>
                <?php
