...
<div class="container">
    <div class="card"></div>
    <div class="card">
        <h1 class="title">Thiết lập mật khẩu mới</h1>
        <?php
        if(isset($error))
        ...
        ?>
        <form method="post" action="<?=$this->uri->uri_string().'?'.$_SERVER['QUERY_STRING']?>" name="login">
            ...
            <div class="input-container">
                ...
                <input name="repassword" type="text" id="password"/>
            </div>
